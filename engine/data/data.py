...
class TextOption:
    ...
    # attributes linked with 'text_options.json'
    def __init__(self, kind: TextKinds.name = TextKinds.default, **kwargs):
        self.__fill_options(kind=kind, **kwargs)
...
class Text:
    def __init__(self, text: str = '',
                 kind: TextKinds.name = TextKinds.default,
                 **params):
        self.text = text
